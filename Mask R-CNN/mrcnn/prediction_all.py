...
COCO_MODEL_PATH = os.path.join(ROOT_DIR, "/home/yu/Mask_RCNN/model/mask_rcnn_maritime_0060.h5")
...
def main():
    ...
    for id in range(0, 28):
        ...
        # 计算ap值并加入到列表中
        persicion, recall, f1 = compute_mAP(r['masks'], original_mask)
        mask_information.append(persicion)
        mask_information.append(recall)
        mask_information.append(f1)

        information.append(mask_information)
    print("预测得到的所有信息", information)
    name = ['y1', 'x1', 'y2', 'x2', 'bbox_width', 'bbox_height', 'percent', 'aera',
            'width', 'width_pixel', 'height', 'height_pixel', 'confidence', 'percision', 'recall', 'f1']
    save_path = '/home/yu/Mask_RCNN/Result/information.csv'
    list2csv(information, save_path, name)
...
#
# original_mask = get_mask(IMAGE_DIR)
#
...
#
# # 计算AP等评估值 打开就能用
# # compute_f1_measure(r['masks'], original_mask)
# # print(compute_mAP(r['masks'], original_mask))
#
# #
